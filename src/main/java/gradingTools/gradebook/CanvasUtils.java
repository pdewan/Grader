...
public class CanvasUtils {	
	static final short ONYEN_COLUMN = 4;
	static final short LAST_NAME_COLUMN = 0;
	static final short FIRST_NAME_COLUMN = 1;
	static final short PID_COLUMN = 3;
	static final short  START_ROW = 2;
	public static Map<String, GradebookEntry> gradebookToMap(StringBuffer aSakaiString) {
		...
		for (int aRowNum = START_ROW; aRowNum < anInputLines.length; aRowNum++) {
	...
	public static void toGradebookRow(StringBuffer anOriginalRow, String aGrade) {
		int aGradeStartIndex = anOriginalRow.lastIndexOf(",");
		anOriginalRow.replace(aGradeStartIndex+1, anOriginalRow.length(), aGrade);		
	}
