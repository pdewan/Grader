...
public class DetailDiaryManagement extends SummaryDiaryManagement {
	public static final int EMAIL_COLUMN = 0;
	public static final int FULL_NAME_COLUMN = 1;
	public static final int DATE_COLUMN = 6;
	public static final int QA_GRADE_COLUMN = 2;
	public static final int DIARY_GRADE_COLUMN = 3;
